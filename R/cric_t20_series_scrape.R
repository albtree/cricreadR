...
cric_t20_series_scrape <- function(x){
  ...
  print(glue('{length_fixture} matches to scrape at an average of 20 seconds means predicted run time = {duration} seconds. Have you checked if this competition ({comp_code_df$competition_code}) is available via the load_bbb_data function?'))
