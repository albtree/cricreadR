...
{
  xrun_1 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/male_1_t20_xrun"))
  xrun_2 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/male_2_t20_xrun"))
  wpa_1 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/male_1_t20_wpa"))
  wpa_2 <- xgb.load(url('https://github.com/albtree/cricreadR/raw/main/models/male_2_t20_wpa'))
  impact_1 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/male_1_t20_impact.rda"))
  impact_2 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/male_2_t20_impact.rda"))
}
  ...
  if (top_row$gender == "male" & top_row$type_clean == "The Hundred")
  {
    ...
    wpa_1 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/male_1_t20_wpa"))
    wpa_2 <- xgb.load(url('https://github.com/albtree/cricreadR/raw/main/models/male_2_t20_wpa'))
    impact_1 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/male_1_100_impact.rda"))
    impact_2 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/male_2_100_impact.rda"))
  }

  if (top_row$gender == "female" & top_row$type_clean == "T20")
  {
    xrun_1 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/female_1_t20_xrun"))
    xrun_2 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/female_2_t20_xrun"))
    wpa_1 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/female_1_t20_wpa"))
    wpa_2 <- xgb.load(url('https://github.com/albtree/cricreadR/raw/main/models/female_2_t20_wpa'))
    impact_1 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/female_1_t20_impact.rda"))
    impact_2 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/female_2_t20_impact.rda"))
  }
  ...
  if (top_row$gender == "female" & top_row$type_clean == "The Hundred")
  {
    ...
    wpa_1 <- xgb.load(url("https://github.com/albtree/cricreadR/raw/main/models/female_1_t20_wpa"))
    wpa_2 <- xgb.load(url('https://github.com/albtree/cricreadR/raw/main/models/female_2_t20_wpa'))
    impact_1 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/female_1_100_impact.rda"))
    impact_2 <- readRDS(url("https://github.com/albtree/cricreadR/raw/main/models/female_2_100_impact.rda"))
  }
